...
class SkillRegistryV2:
    ...
    def _register_builtins(self) -> None:
        builtins: list[dict[str, Any]] = [
            ...
            {"skill_id": "deeplens_autograd_audit",
             "name": "DeepLens Autograd Audit",
             "description": "Audit autograd graph through GeoLens geometric PSF.", "required_backends": [],
             "produced_artifacts": ["audit_result.json"], "evidence_level": "diagnostic_evidence",
             "risk_level": "low", "timeout_sec": 300, "allowed_execution_targets": ["dry_run", "local"],
             "tags": ["deeplens", "autograd", "diagnostic"], "claim_implications": ["diagnostic_evidence"]},
            {"skill_id": "deeplens_trainable_parameter_inspection",
             "name": "Trainable Parameter Inspection",
             "description": "Inspect GeoLens trainable parameters and gradient flow.", "required_backends": [],
             "produced_artifacts": ["inspection_result.json"], "evidence_level": "diagnostic_evidence",
             "risk_level": "low", "timeout_sec": 300, "allowed_execution_targets": ["dry_run", "local"],
             "tags": ["deeplens", "diagnostic"], "claim_implications": ["diagnostic_evidence"]},
            {"skill_id": "deeplens_curriculum_probe",
             "name": "DeepLens Curriculum Probe",
             "description": "Lightweight staged curriculum probe.", "required_backends": [],
             "produced_artifacts": ["curriculum_result.json"], "evidence_level": "diagnostic_evidence",
             "risk_level": "low", "timeout_sec": 120, "allowed_execution_targets": ["dry_run", "local"],
             "tags": ["deeplens", "curriculum"], "claim_implications": ["diagnostic_evidence"]},
            {"skill_id": "deeplens_regularized_probe",
             "name": "DeepLens Regularized Probe",
             "description": "Optical regularization probe.", "required_backends": [],
             "produced_artifacts": ["reg_probe_result.json"], "evidence_level": "diagnostic_evidence",
             "risk_level": "low", "timeout_sec": 120, "allowed_execution_targets": ["dry_run", "local"],
             "tags": ["deeplens", "regularization"], "claim_implications": ["diagnostic_evidence"]},
            {"skill_id": "deeplens_component_first_probe",
             "name": "Component-First Probe",
             "description": "Probe individual DeepLens optical components.", "required_backends": [],
             "produced_artifacts": ["component_probe_result.json"], "evidence_level": "diagnostic_evidence",
             "risk_level": "low", "timeout_sec": 300, "allowed_execution_targets": ["dry_run", "local"],
             "tags": ["deeplens", "component"], "claim_implications": ["diagnostic_evidence", "native_component_optimization"]},
            {"skill_id": "gradient_instability_diagnosis",
             "name": "Gradient Instability Diagnosis",
             "description": "Diagnose GeoLens native optical gradient instability from sweep results and remote job data.",
             "required_backends": [],
             "produced_artifacts": ["diagnosis.json", "diagnosis.md"],
             "evidence_level": "diagnostic_evidence",
             "risk_level": "low", "timeout_sec": 60,
             "allowed_execution_targets": ["dry_run", "local"],
             "tags": ["diagnosis", "gradient", "instability", "geolens"],
             "claim_implications": ["diagnostic_evidence"]},
